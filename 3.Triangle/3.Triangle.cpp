    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MY3TRIANGLE, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY3TRIANGLE));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_MY3TRIANGLE);
