    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MY6DEPTH, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY6DEPTH));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_MY6DEPTH);
