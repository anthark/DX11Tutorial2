    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MY5TEXTURES, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY5TEXTURES));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_MY5TEXTURES);
