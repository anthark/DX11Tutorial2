    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MY4MATRICES, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY4MATRICES));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_MY4MATRICES);
